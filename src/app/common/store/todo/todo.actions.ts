...
export class GetTodosFailed implements Action {
    readonly type = TodoActionType.GET_TODOS_FAILED;
...
export class AddTodoFailed implements Action {
    readonly type = TodoActionType.ADD_TODO_FAILED;
    constructor(public payload: string) { }
}
...
export class UpdateTodoSuccess implements Action {
    readonly type = TodoActionType.UPDATE_TODO_SUCCESS;
    constructor(public payload: Todo) { }
}

export class UpdateTodoFailed implements Action {
    readonly type = TodoActionType.UPDATE_TODO_FAILED;
    constructor(public payload: string) { }
}
...
export class DeleteTodoFailed implements Action {
    readonly type = TodoActionType.DELETE_TODO_FAILED;
    constructor(public payload: string) { }
}
